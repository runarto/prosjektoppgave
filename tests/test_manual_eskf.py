#!/usr/bin/env python3
"""
Test manual ESKF implementation on realistic space-grade data.
"""
...
def main():
    print("="*70)
    print("MANUAL ESKF TEST - REALISTIC SPACE-GRADE DATA")
    print("="*70)
    ...
    eskf = ESKF(P0=P0, config_path="configs/config_spacegrade_realistic.yaml")
    ...
    print(f"Magnetometer updates: {n_mag_updates}")
    print(f"Sun sensor updates: {n_sun_updates}")
    print(f"Star tracker updates: {n_st_updates}")
    print(f"\nAttitude Error:")
